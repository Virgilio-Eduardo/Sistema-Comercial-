...
$select_account->execute([ $get_id2]);
...
<section class="form-container">
    <form action="" method="POST">
      ...
      <div class="box">
      <?php
        if(!empty($fetch_account['img'])){       
        ?>
        <img src="../uploaded_files/<?= $fetch_account['img'];?>" alt="">

        <div class="botao">
        <input type="submit" name="delete_img" class="btnA" value="Apagar imagem"
        ...
        <?php  }; ?>
          ...
          <i></i><input type="text" name="nome"  maxlength="50" class="box"  placeholder="<?= $fetch_account['nome']; ?>">

          <i></i><input type="number" name="number" class="box" min="0" max="99999999999" maxlength="11" placeholder="<?= $fetch_account['number']; ?>">
          
          <i></i><input type="email" name="email" class="box"  maxlength="50" placeholder="<?= $fetch_account['email']; ?>">

          <i></i><input type="password" name="old_password" class="box"  maxlength="15"  placeholder="Digite o seu antigo password">

          <i></i><input type="password" name="new_password" class="box"  maxlength="15"  placeholder="Digite o seu novo password">

          <i></i><input type="password" name="c_password" class="box" maxlength="15"  placeholder="Confirma o seu novo password">


          <?php if($nivel_acesso == 5){ ?> <input type="submit" value="Atualizar" name="submit" class="btn"> <?php }?>
