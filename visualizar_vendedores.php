...
<head>
  ...
  href="https://unpkg.com/boxicons@latest/css/boxicons.min.css">
    <title>Visualizar Vendedores</title>
</head>
<body>
...
<div class="box-container">
      ...
      <div class="zona-ordens">
          ...
          <div class="table-responsive" >
              <table class ="table">
                  ...
                  <?php
                    $selecionar_users = $conn->prepare("SELECT * FROM `users` WHERE  nivel_acesso = 1
                     ");
                  ...
                  <tbody>
                      ...
                      <input type="hidden" name="usuario_id" value="<?= $usuario_id;?>">
                          ...
                          <td data-label="On">#</td>
                          <td data-label="Nome da loja"><p class="nome_loja"><?php echo $nome_loja;?></p></td>
                          <td data-label="Perfil"><img src="../uploaded_files/<?=$fetch_usuarios['img'];?>"  alt=""></td>
      ...
      <div class="flex-btn">
                <div class="box">
                    <a href="visualizar_transportadores.php">Visualizar transportadores ></a>
                </div>
